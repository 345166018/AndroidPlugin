...
public class MyReceiver extends BroadcastReceiver implements PayInterfaceBroadcast {
    ...
    public void attach(Context context) {
        Toast.makeText(context, "-----绑定上下文成功-----", Toast.LENGTH_SHORT).show();//context:ProxyActivity
//        Toast.makeText(context, "context class name "+context.getClass().getSimpleName(), Toast.LENGTH_SHORT).show();
    }
